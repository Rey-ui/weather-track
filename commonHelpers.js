import{a as M,i as p}from"./assets/vendor-db25513e.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=o(i);fetch(i.href,r)}})();const q="169e2d2ec6f9ef07a3c4e60acede402f",I="https://api.openweathermap.org/data/2.5";async function g(t){const e=await M.get(`${I}/weather`,{params:{appid:q,q:t}});return console.log(e.data),e.data}function f(t,e){if(t.length>0){const o=t.map(({id:s,name:i,main:{humidity:r,temp:c},weather:u,wind:{speed:d}})=>{const v=u[0].main,$=C(v);return`<li id="${s}" class="our-cities__item">
              ...
              </li>`}).join("");e.insertAdjacentHTML("beforeend",o)}else e.innerHTML='<p class="alternative">There are no cities yet</p>'}function A(t){return JSON.parse(localStorage.getItem(t))||[]}function w(t,e){return localStorage.setItem(e,JSON.stringify(t))}const h="citiesList",H=document.querySelector(".our-cities__form"),a=document.querySelector(".our-cities__list"),O=document.querySelector(".popular-cities__list"),x=document.querySelector(".our-cities__clear-btn"),l=document.querySelector(".our-cities__refresh-btn"),L=document.querySelector(".loader"),b=document.querySelector(".our-cities__loader"),P=document.querySelector(".our-cities__bar-sorts-btns");let n=A(h)||[];function C(t){return{Clear:"icon-sun",Clouds:"icon-cloud",Rain:"icon-cloud-rain",Drizzle:"icon-cloud-drizzle",Thunderstorm:"icon-cloud-lightning",Snow:"icon-cloud-snow",Mist:"icon-weather-windy",Smoke:"icon-weather-windy",Haze:"icon-weather-windy-cloudy",Dust:"icon-triangle",Fog:"icon-eye-off",Sand:"icon-chart-area",Ash:"icon-chart-area",Squall:"icon-warning",Tornado:"icon-warning"}[t]||"icon-cloud"}async function N(t){t.preventDefault();const e=t.currentTarget,o=e.elements.city.value.trim();if(E(),!o){p.error({title:"Error",message:"❌Please enter the correct city name!"});return}try{const s=await g(o);if(console.log(s.weather[0].main),!s||s.length===0)return;{a.innerHTML="";const i=S(s);console.log(n),f(i,a),l.classList.add("active-btn")}}catch(s){console.log(s),p.error({title:"Error",message:"❌Sorry, nothing was found for your request!"})}finally{T(),e.reset()}}function k(t,e){e.innerHTML="",f(t,e),t.length&&l.classList.add("active-btn")}function z(t){const e=t.target.closest(".our-cities__item-btn");if(!e)return;const o=e.closest("li"),s=Number(o.id),i=n.filter(r=>r.id!==s);n.length=0,n.push(...i),w(n,h),n.length?l.classList.add("active-btn"):l.classList.remove("active-btn"),k(n,a)}function B(){a.innerHTML='<p class="alternative">There are no cities yet</p>',n.length=0,localStorage.removeItem(h),l.classList.remove("active-btn")}function S(t){return n.some(o=>o.id===t.id)?(p.error({title:"Error",message:"❌Sorry, already exists!"}),n):(n.push(t),w(n,h),n)}async function j(){const t=n.map(({name:e})=>e);n.length=0,E();try{for(let e of t){const o=await g(e);a.innerHTML="";const s=S(o);f(s,a)}}catch(e){console.log(e)}finally{T()}}function T(){b.classList.add("hidden")}function E(){b.classList.remove("hidden")}function D(){n.length?l.classList.add("active-btn"):l.classList.remove("active-btn")}D();function K({id:t,name:e,main:{temp:o},weather:s}){const i=s[0].main,r=C(i);return`<li id="${t}" class="popular-cities__item">
